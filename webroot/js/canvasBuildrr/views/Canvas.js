		...
		initialize: function( attrs ) {
			...
			document.addEventListener('mediaBrowserMediaSelected', function (e) {
				...
				var image = new ImageObject({
					'type': 'ImageObject',
					'content': "/theme/default/files/images/" + model.attributes.filename + "." + model.attributes.extension
				});
			...
			document.addEventListener('mediaBrowserMediaUnSelected', function (e) {
				var model = e.detail;
				var collection = Backbone.AppModel.get('collection');
				var relativeFilePath = "/theme/default/files/images/" + model.attributes.filename + "." + model.attributes.extension;
