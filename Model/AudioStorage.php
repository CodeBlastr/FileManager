 ...
 * @license MIT
 */
class AudioStorage extends FileStorage {
 ...
 */
	public function beforeSave($options = array()) {
		...
		$Event = new CakeEvent('AudioStorage.beforeSave', $this, array(
			'record' => $this->data));
 ...
 */
	public function afterSave($created, $options = array()) {
		if ($created) {
			...
			$Event = new CakeEvent('AudioStorage.afterSave', $this, array(
				'created' => $created,
 ...
 */
	public function beforeDelete($cascade = true) {
		...
		$Event = new CakeEvent('AudioStorage.beforeDelete', $this, array(
			'record' => $this->record,
 ...
 */
	public function afterDelete() {
		$Event = new CakeEvent('AudioStorage.afterDelete', $this, array(
			'record' => $this->record,
			'storage' => $this->getStorageAdapter($this->record[$this->alias]['adapter'])));
		$this->getEventManager()->dispatch($Event);
	}
