...
$uuid = !empty($uuid) ? $uuid : substr(str_shuffle(str_repeat('abcdefghijklmnopqrstuvwxyz0123456789',20)),0,40);$offset = !empty($offset) ? $offset : 0; ?>
		...
		<?php echo $this->Html->css('/file_manager/record.v3/history/history'); ?>
		<?php echo $this->Html->script('/file_manager/record.v3/history/history'); ?>
        <!-- END Browser History required section -->  
            
		<?php echo $this->Html->script('/file_manager/record.v3/swfobject'); ?>
        <script type="text/javascript">
            // For version detection, set to min. required Flash Player version, or 0 (or 0.0.0), for no version detection. 
            var swfVersionStr = "10.2.0";
            // To use express install, set to playerProductInstall.swf, otherwise the empty string. 
            var xiSwfUrlStr = "/file_manager/record.v3/playerProductInstall.swf";
            var flashvars = {};
            var params = {};
            params.quality = "high";
            ...
            swfobject.embedSWF(
                "/file_manager/record.v3/red5recorder.swf", "flashContent", 
                "100%", "100%", 
    ...
    <body>
        ...
        <noscript>
            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%" id="red5recorder">
                <param name="movie" value="/file_manager/record.v3/red5recorder.swf" />
                <param name="quality" value="high" />
                <param name="bgcolor" value="#869ca7" />
                <param name="allowScriptAccess" value="sameDomain" />
                <param name="allowFullScreen" value="true" />
                <!--[if !IE]>-->
                <object type="application/x-shockwave-flash" data="/file_manager/record.v3/red5recorder.swf" width="100%" height="100%">
                    <param name="quality" value="high" />
                    <param name="bgcolor" value="#869ca7" />
                    <param name="allowScriptAccess" value="sameDomain" />
                    <param name="allowFullScreen" value="true" />
