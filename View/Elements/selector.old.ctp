...
//Format the file regardless of how it sent
...
<script type="text/javascript">
	...
	var baseUrl = '<?php echo $this->Html->url(array('plugin' => 'file_manager', 'controller' => 'file_manager', 'action' => 'media')); ?>';
</script>
...
<?php else: ?>
	...
	<script data-main="/FileManager/js/mediabrowser_boot2/scripts/mediabrowser.js" src="/FileManager/js/mediabrowser/scripts/require.js"></script>
